...
import { MdAdd, MdEdit, MdDelete, MdCreditCard, MdEmail, MdAccountBalance, MdFeaturedPlayList, MdAttachMoney, MdAutoGraph } from 'react-icons/md';
...
export default function Contas() {
    ...
    const iconesTipoConta = {
      'CONTA_CORRENTE': <MdAccountBalance className='h-6 w-6'/>,
      'POUPANCA': <MdEmail className='h-6 w-6'/>,
      'CARTAO_CREDITO': <MdCreditCard className='h-6 w-6'/>,
      'CARTAO_DEBITO': <MdFeaturedPlayList className='h-6 w-6'/>,
      'DINHEIRO': <MdAttachMoney className='h-6 w-6'/>,
      'INVESTIMENTO': <MdAutoGraph className='h-6 w-6'/>,
    }
        ...
        return (
            <div key={item.id} className={Estilos.linhaListagem}>
                ...
                <div className='flex-1 ml-4'>
                    ...
                    <p className='text-sm text-gray-700'>{nomesTipoConta[item.tipo_conta]}</p>
                </div>
